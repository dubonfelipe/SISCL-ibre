...
echo '<br/><form method="post" action="Admin_frm_asig.php" class="form-horizontal"><div style="text-align:center"> <input type="hidden" name="cui" value="'.$dpi.'"><input type="submit" id="btnAsignar" name="btnAsignar" class="btn btn-primary" value="Ir Asignarse Curso"></div></div></form>';
//
