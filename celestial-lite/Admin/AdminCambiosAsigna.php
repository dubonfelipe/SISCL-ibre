...
/**
 * Template Name: Formulario para Ingreso a Cambios de asignacion
 *
 * @file           AdminCambiosAsigna.php
			...
			$.ajax({
        		...
        		success: function (data) {
          			if (data == 0) {
            			...
            			window.location.replace(" http://localhost/wordpress/formulario-de-cambios-en-asignacion/?"
            				+data+"&vcod="+codAsig);
