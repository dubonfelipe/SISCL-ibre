...
/**
 * Template Name: Formulario para Realizar Nuevas Asignaciones
 *
 * @file           AdminFormCambiosAsig.php
...
require('include/Admin_option.inc.php');	
	...
	if ( !isset($_POST['cui']) OR !isset($_POST['Asc'])) {
...
<section>
	<div id="primary" class="site-content span12">
		...
		<form method="post" action="../Admin_new_add.php" class="form-horizontal">
    <div class="container">
